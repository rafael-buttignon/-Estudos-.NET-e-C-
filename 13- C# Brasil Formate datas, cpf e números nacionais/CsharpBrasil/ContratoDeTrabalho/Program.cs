        ...
        static void Main(string[] args)
        {
            var contrato = new
            {
                Empresa = new {
                    ...
                    CNPJ = new CNPJFormatter().Format("43606984000161"),
                ...
                {
                    Nome = "Mario Mario",
                    Cpf = new CPFFormatter().Format("38728260854"),
                    RG = "123456789-00",
...
EMPREGADO: {contrato.Funcionario.Nome}, {contrato.Funcionario.Nacionalidade}, {contrato.Funcionario.EstadoCivil}, portador da cédula de identidade R.G. nº {contrato.Funcionario.RG} e CPF/MF nº {contrato.Funcionario.RG}, residente e domiciliado na {contrato.Funcionario.Endereco.Logradouro}, {contrato.Funcionario.Numero}, {contrato.Funcionario.Endereco.Bairro}, CEP {contrato.Funcionario.Endereco.CEP}, {contrato.Funcionario.Endereco.Localidade}, {contrato.Funcionario.Endereco.UF}.
